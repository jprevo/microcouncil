...
const ENTRIES: readonly EmojiEntry[] = Object.entries(TABLE).map(([code, char]) => ({ code, char }));
...
export function searchEmojis(query: string, limit: number): readonly EmojiEntry[] {
